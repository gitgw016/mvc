...
public class MemberDAOImpl implements MemberDAO {
	...
	public MemberVO memberLogin(String id, String pass) {
		...
		try {
			...
			if(rs.next()) {
				member = new MemberVO(rs.getInt(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getInt(5),rs.getString(6),rs.getString(7),rs.getTimestamp(8),rs.getTimestamp(9));
			}
		} catch (SQLException e) {
			e.printStackTrace();
		}finally {
